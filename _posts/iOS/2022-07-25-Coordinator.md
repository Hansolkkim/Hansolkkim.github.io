...
class HomeCoordinator: Coordinator {
    ...
    // private var paymentMethodsList: [PaymentMethod] = []
    private var paymentMethodsList: [PaymentMethod] = [PaymentMethod(id: "", name: "", digits: "", color: "", isPrimary: false)]
    ...
    func start() {
        let viewController = HomeViewController(navigation: self)
        navigationController.pushViewController(viewController, animated: true)
    }
}
...
private extension HomeCoordinator {
    func showTopupView() {
        let topupViewController = UIViewController()
        topupViewController.view.backgroundColor = .yellow
        topupViewController.title = "금액 충전"

        navigationController.pushViewController(topupViewController, animated: true)
    }

    func showAddPaymentMethodView() {
        let addPaymentMethodViewController = UIViewController()
        addPaymentMethodViewController.view.backgroundColor = .blue
        addPaymentMethodViewController.title = "카드 추가"

        navigationController.pushViewController(addPaymentMethodViewController, animated: true)
    }
}
...
class HomeViewController: UIViewController {
    ...
    func setupViews() {
        ...
        NSLayoutConstraint.activate([
            ...
            topupButton.widthAnchor.constraint(equalToConstant: 100),
